...
namespace WebMVC.Data.Migrations
{
    ...
    [Migration("20200108082115_ShopAgentViewModel")]
    partial class ShopAgentViewModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMVC.Applications.Queries.ShopAgents.ShopAgent", b =>
                {
                    b.OwnsOne("WebMVC.Applications.Queries.Balances.ShopAgentBalance", "Balance", b1 =>
                        {
                            ...
                            b1.OwnsOne("WebMVC.Applications.Queries.Balances.WithdrawalLimit", "WithdrawalLimit", b2 =>
                                {
                                    b2.Property<string>("ShopAgentBalanceShopAgentId")
                                        .HasColumnType("nvarchar(450)");
                                    ...
                                    b2.HasKey("ShopAgentBalanceShopAgentId");

                                    b2.ToTable("shopAgents");

                                    b2.WithOwner()
                                        .HasForeignKey("ShopAgentBalanceShopAgentId");
                                });
                        });
