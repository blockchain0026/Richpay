...
namespace WebMVC.Data.Migrations.Pairing
{
    ...
    [Migration("20200221183154_InitialCreate")]
            ...
            modelBuilder.Entity("Pairing.Domain.Model.QrCodes.QrCode", b =>
                {
                    ...
                    b.HasIndex("_paymentChannelId", "_paymentSchemeId", "DateLastTraded", "MinCommissionRate", "AvailableBalance", "SpecifiedShopId", "QuotaLeftToday")
                        .HasAnnotation("SqlServer:Clustered", false);
