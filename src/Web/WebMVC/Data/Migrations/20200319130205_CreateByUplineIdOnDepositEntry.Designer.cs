...
namespace WebMVC.Data.Migrations
{
    ...
    [Migration("20200319130205_CreateByUplineIdOnDepositEntry")]
    partial class CreateByUplineIdOnDepositEntry
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.BankbookRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.DepositEntry", b =>
                {
                    ...
                    b.Property<string>("CreateByUplineId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.OrderEntry", b =>
                {
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.QrCodeEntry", b =>
                {
                    b.Property<int>("QrCodeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.RunningAccountRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.Shop", b =>
                {
                    b.Property<string>("ShopId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.ShopAgent", b =>
                {
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.ShopGatewayEntry", b =>
                {
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.TempRunningAccountRecord", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.Trader", b =>
                {
                    b.Property<string>("TraderId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.TraderAgent", b =>
                {
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.WithdrawalEntry", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebMVC.Models.Queries.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.DepositEntry", b =>
                {
                    b.OwnsOne("WebMVC.Models.Queries.DepositBankAccount", "DepositBankAccount", b1 =>
                        {
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.QrCodeEntry", b =>
                {
                    b.OwnsOne("WebMVC.Models.Queries.PairingInfo", "PairingInfo", b1 =>
                        {
                    ...
                    b.OwnsOne("WebMVC.Models.Queries.QrCodeEntrySetting", "QrCodeEntrySetting", b1 =>
                        {
                            b1.Property<int>("QrCodeEntryQrCodeId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.Shop", b =>
                {
                    b.OwnsOne("WebMVC.Models.Queries.RebateCommission", "RebateCommission", b1 =>
                        {
                    ...
                    b.OwnsOne("WebMVC.Models.Queries.ShopUserBalance", "Balance", b1 =>
                        {
                            b1.Property<string>("ShopId")
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.OwnsOne("WebMVC.Models.Queries.WithdrawalLimit", "WithdrawalLimit", b2 =>
                                {
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.ShopGatewayEntry", b =>
                {
                    b.OwnsOne("WebMVC.Models.Queries.AlipayPreferenceInfo", "AlipayPreferenceInfo", b1 =>
                        {
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.Trader", b =>
                {
                    b.OwnsOne("WebMVC.Models.Queries.Balance", "Balance", b1 =>
                        {
                    ...
                    b.OwnsOne("WebMVC.Models.Queries.TradingCommission", "TradingCommission", b1 =>
                        {
                            b1.Property<string>("TraderId")
                                .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebMVC.Models.Queries.WithdrawalEntry", b =>
                {
                    b.OwnsOne("WebMVC.Models.Queries.WithdrawalBankOption", "WithdrawalBankOption", b1 =>
                        {
