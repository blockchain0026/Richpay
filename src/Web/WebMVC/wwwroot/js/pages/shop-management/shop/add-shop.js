	...
	var initWizard = function () {
		...
		wizard.on('beforeNext', function (wizardObj) {
			...
			if (nextStep === wizardObj.totalSteps) {
				...
				var urlData = formEl.find('[name ="siteaddress"]').val();
				...
				personalInfo += '<br /> 网址: &ensp; ' + (urlData ? urlData : '-');
				...
				var rateRebateAlipay = formEl.find('input[name ="raterebatealipayinthousandth"]').val();
				var rateRebateWechat = formEl.find('input[name ="raterebatewechatinthousandth"]').val();
				...
				riskInfo += '<br /> 支付宝返佣: &ensp; 千分之 ' + (rateRebateAlipay ? rateRebateAlipay : '-');
				riskInfo += '<br /> 微信返佣: &ensp; 千分之 ' + (rateRebateWechat ? rateRebateWechat : '-');
	...
	var initSelect = function () {
		function formatItem(item) {
			...
			markup += "<div class='select2-result-repository__statistics'>" +
				"<div class='select2-result-repository__forks'><i class='fa fa-star'></i> 支付宝返佣: " + item.rate_rebate_alipay + " </div>" +
				"<div class='select2-result-repository__stargazers'><i class='fa fa-star'></i> 微信返佣: " + item.rate_rebate_wechat + " </div>" +
					...
					return {
						results: $.map(data.data, function (item) {
							...
							return {
								...
								rate_rebate_alipay: alipayRate,
								rate_rebate_wechat: wechatRate,
