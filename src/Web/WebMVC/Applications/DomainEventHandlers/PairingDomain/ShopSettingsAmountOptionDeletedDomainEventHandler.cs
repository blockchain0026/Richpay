...
namespace WebMVC.Applications.DomainEventHandlers.PairingDomain
{
    ...
    /// </summary>
    public class ShopSettingsAmountOptionDeletedDomainEventHandler
            : INotificationHandler<ShopSettingsAmountOptionDeletedDomainEvent>
    {
        private readonly IQrCodeRepository _qrCodeRepository;

        public ShopSettingsAmountOptionDeletedDomainEventHandler(IQrCodeRepository qrCodeRepository)
        {
            _qrCodeRepository = qrCodeRepository ?? throw new ArgumentNullException(nameof(qrCodeRepository));
        }

        public async Task Handle(ShopSettingsAmountOptionDeletedDomainEvent domainEvent, CancellationToken cancellationToken)
        {
