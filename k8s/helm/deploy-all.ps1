Param(
    ...
    [parameter(Mandatory=$false)][string]$appName="richpay",
    ...
    [parameter(Mandatory=$false)][string]$tlsSecretName = "richpay-tls-custom",
...
Write-Host "Begin Richpay installation using Helm" -ForegroundColor Green
...
if ($deployInfrastructure) {
    ...
    Write-Host "Richpay infrastructure (bbdd, redis, ...) charts aren't installed (-deployCharts is false)" -ForegroundColor Yellow
}
